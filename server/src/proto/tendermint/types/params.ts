...
export const ConsensusParams: MessageFns<ConsensusParams> = {
  encode(message: ConsensusParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.blob !== undefined) {
      BlobParams.encode(message.blob, writer.uint32(66).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.blob = BlobParams.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ConsensusParams {
    return {
      ...
      blob: isSet(object.blob) ? BlobParams.fromJSON(object.blob) : undefined,
    };
  },
  ...
  toJSON(message: ConsensusParams): unknown {
    ...
    if (message.blob !== undefined) {
      obj.blob = BlobParams.toJSON(message.blob);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ConsensusParams>, I>>(object: I): ConsensusParams {
    ...
    message.blob = (object.blob !== undefined && object.blob !== null)
      ? BlobParams.fromPartial(object.blob)
      : undefined;
    return message;
  },
};
...
function createBaseBlobParams(): BlobParams {
  return { maxBytes: 0 };
}

export const BlobParams: MessageFns<BlobParams> = {
  encode(message: BlobParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.maxBytes !== 0) {
      writer.uint32(8).int64(message.maxBytes);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BlobParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBlobParams();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): BlobParams {
    return {
      maxBytes: isSet(object.maxBytes)
        ? globalThis.Number(object.maxBytes)
        : isSet(object.max_bytes)
  ...
  toJSON(message: BlobParams): unknown {
    const obj: any = {};
    if (message.maxBytes !== 0) {
      obj.maxBytes = Math.round(message.maxBytes);
    }
  ...
  create<I extends Exact<DeepPartial<BlobParams>, I>>(base?: I): BlobParams {
    return BlobParams.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BlobParams>, I>>(object: I): BlobParams {
    const message = createBaseBlobParams();
    message.maxBytes = object.maxBytes ?? 0;
    return message;
  },

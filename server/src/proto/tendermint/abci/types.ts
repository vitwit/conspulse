...
export interface ResponseExtendVote {
  /** this extension's signature is replay-protected by CometBFT */
  voteExtension: Uint8Array;
  /** this extension's signature is _not_ replay-protected by CometBFT */
...
export const RequestProcessProposal: MessageFns<RequestProcessProposal> = {
  encode(message: RequestProcessProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.blob.length !== 0) {
      writer.uint32(74).bytes(message.blob);
    }
    return writer;
  },
  ...
  fromJSON(object: any): RequestVerifyVoteExtension {
    return {
      ...
      nonRpVoteExtension: isSet(object.nonRpVoteExtension)
        ...
        : isSet(object.non_rp_vote_extension)
...
function createBaseResponsePrepareProposal(): ResponsePrepareProposal {
  return { txs: [], blob: new Uint8Array(0) };
}
  ...
  fromJSON(object: any): ResponseExtendVote {
    return {
      voteExtension: isSet(object.voteExtension)
        ...
        ? bytesFromBase64(object.vote_extension)
        : new Uint8Array(0),
      nonRpExtension: isSet(object.nonRpExtension)
        ? bytesFromBase64(object.nonRpExtension)
        : isSet(object.non_rp_extension)
        ? bytesFromBase64(object.non_rp_extension)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): ExtendedVoteInfo {
    return {
      ...
      nonRpExtensionSignature: isSet(object.nonRpExtensionSignature)
        ...
        : isSet(object.non_rp_extension_signature)

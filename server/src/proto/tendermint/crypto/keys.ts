...
export interface PublicKey {
  ...
  secp256k1Uncompressed?: Uint8Array | undefined;
}

function createBasePublicKey(): PublicKey {
  return { ed25519: undefined, secp256k1: undefined, secp256k1Uncompressed: undefined };
}
...
export const PublicKey: MessageFns<PublicKey> = {
  encode(message: PublicKey, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.secp256k1Uncompressed !== undefined) {
      writer.uint32(26).bytes(message.secp256k1Uncompressed);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.secp256k1Uncompressed = reader.bytes();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): PublicKey {
    return {
      ...
      secp256k1Uncompressed: isSet(object.secp256k1Uncompressed)
        ? bytesFromBase64(object.secp256k1Uncompressed)
        : isSet(object.secp256k1_uncompressed)
        ? bytesFromBase64(object.secp256k1_uncompressed)
        : undefined,
    };
  },
  ...
  toJSON(message: PublicKey): unknown {
    ...
    if (message.secp256k1Uncompressed !== undefined) {
      obj.secp256k1Uncompressed = base64FromBytes(message.secp256k1Uncompressed);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<PublicKey>, I>>(object: I): PublicKey {
    ...
    message.secp256k1Uncompressed = object.secp256k1Uncompressed ?? undefined;
    return message;
  },
};
